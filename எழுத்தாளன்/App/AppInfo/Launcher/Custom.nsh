...
;${SegmentPrePrimary}
	;StrCpy $1 $EXEDIR\Data\Scribus\scribus150.rc
	;StrCpy $2 /SCRIBUSRC/ExternalTools
	;StrCpy $3 ImageEditor
	;ReadEnvStr $PADir PAL:PortableAppsDir:ForwardSlash
	;${ReadUserConfig} $UseCustomImageEditor UseCustomImageEditor
	;	${If} $UseCustomImageEditor == "fsc"
	;		StrCpy $4 $PADir/fscPortable/fscPortable.exe
	;		${XMLWriteAttrib} $1 $2 $3 $4
	;	${ElseIf} $UseCustomImageEditor == "fotografix"
	;		StrCpy $4 $PADir/FotografixPortable/FotografixPortable.exe
	;		${XMLWriteAttrib} $1 $2 $3 $4
	;	${ElseIf} $UseCustomImageEditor == "gimp"
	;		StrCpy $4 $PADir/GIMPPortable/GIMPPortable.exe
	;		${XMLWriteAttrib} $1 $2 $3 $4
	;	${ElseIf} $UseCustomImageEditor == "krita"
	;		StrCpy $4 $PADir/KritaPortable/KritaPortable.exe
	;		${XMLWriteAttrib} $1 $2 $3 $4
	;	${ElseIf} $UseCustomImageEditor == "lazpaint"
	;		StrCpy $4 $PADir/LazPaintPortable/LazPaintPortable.exe
	;		${XMLWriteAttrib} $1 $2 $3 $4
	;	${ElseIf} $UseCustomImageEditor == "mypaint"
	;		StrCpy $4 $PADir/MyPaintPortable/MyPaintPortable.exe
	;		${XMLWriteAttrib} $1 $2 $3 $4
	;	${ElseIf} $UseCustomImageEditor == "photofiltre"
	;		StrCpy $4 $PADir/PhotofiltrePortable/PhotofiltrePortable.exe
	;		${XMLWriteAttrib} $1 $2 $3 $4
	;	${ElseIf} $UseCustomImageEditor == "picpick"
	;		StrCpy $4 $PADir/PicPickPortable/PicPickPortable.exe
	;		${XMLWriteAttrib} $1 $2 $3 $4
	;	${ElseIf} $UseCustomImageEditor == "fsv"
	;		StrCpy $4 $PADir/FSViewerPortable/FSViewerPortable.exe
	;		${XMLWriteAttrib} $1 $2 $3 $4
	;	${ElseIf} $UseCustomImageEditor == "irfanview"
	;		StrCpy $4 $PADir/IrfanViewPortable/IrfanViewPortable.exe
	;		${XMLWriteAttrib} $1 $2 $3 $4
	;	${ElseIf} $UseCustomImageEditor == "jpegview"
	;		StrCpy $4 $PADir/JPEGViewPortable/JPEGViewPortable.exe
	;		${XMLWriteAttrib} $1 $2 $3 $4
	;	${ElseIf} $UseCustomImageEditor == "xnview"
	;		StrCpy $4 $PADir/XnViewPortable/XnViewPortable.exe
	;		${XMLWriteAttrib} $1 $2 $3 $4
	;	${ElseIf} $UseCustomImageEditor == "inkscape"
	;		StrCpy $4 $PADir/InkscapePortable/InkscapePortable.exe
	;		${XMLWriteAttrib} $1 $2 $3 $4
	;	${EndIf}
;!macroend
