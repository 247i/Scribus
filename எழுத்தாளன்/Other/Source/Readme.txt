...
user in an INI file next to ScribusPortableTest.exe called ScribusPortableTest.ini.
...
copy AppNamePortable.ini from this directory to ScribusPortableTest.ini next to
ScribusPortableTest.exe. The options in the INI file are as follows:
